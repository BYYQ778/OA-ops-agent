...
def create_app(
    ...
    application = FastAPI(title="OA 智能运维 Agent", version="3.0.1", lifespan=_lifespan)
...
async def login_page(request: Request):
    ...
    html = template.render(version="3.0.1", cache_buster=str(int(time.time())))
    return HTMLResponse(html)
